...
#   XSA=TRUE XSA_ALPHA=0.5 XSA_LAYER_INDICES=0,3,7 bash runs/pace_submit.sh
...
JOB1=$(sbatch --parsable \
    --export=ALL,WANDB_RUN=$WANDB_RUN,XSA=$XSA,XSA_ALPHA=$XSA_ALPHA,XSA_LAYER_INDICES=$XSA_LAYER_INDICES \
